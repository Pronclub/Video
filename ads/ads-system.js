...
const directLink = "https://otieu.com/4/9835089";
...
// State variables
let clickCount = 0;
let requiredClicks = Math.floor(Math.random() * 2) + 1; // 1 or 2
...
function unlockContent() {
    ...
    // Load external ad script after ads are completed
    loadExternalAdScript();
}

function loadExternalAdScript() {
    // Create and append the external ad script
    ...
    console.log('External ad script loaded after ads completion');
}
...
function handlePageClick(event) {
    ...
    if (episodeCard) {
        ...
        // Reset ads system after 2 minutes
        setTimeout(() => {
            resetAdsSystem();
        }, 2 * 60 * 1000); // 2 minutes
        return;
